...
#define RUBY_ARCHLIB "/usr/local/lib/ruby/1.9.1/i686-linux"
#define RUBY_SITE_ARCHLIB "/usr/local/lib/ruby/site_ruby/1.9.1/i686-linux"
#define RUBY_VENDOR_ARCHLIB "/usr/local/lib/ruby/vendor_ruby/1.9.1/i686-linux"
